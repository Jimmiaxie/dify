const translation = {
  ...
  welcome: 'Bine ai venit la Xbrother, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Xbrother Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe Xbrother',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează Xbrother',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Xbrother și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Xbrother. Contactați administratorul pentru a continua să utilizați Xbrother.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Xbrother Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Xbrother.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Xbrother Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Xbrother.',
}
