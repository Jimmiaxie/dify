const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Xbrother cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Xbrother.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Xbrother Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
