const translation = {
  ...
  welcome: 'Benvenuto su Xbrother, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Xbrother Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Xbrother',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Xbrother',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Xbrother e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Xbrother. Contatta il tuo amministratore per continuare a utilizzare Xbrother.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Xbrother Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Xbrother.',
  licenseInactiveTip: 'La licenza Xbrother Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Xbrother.',
