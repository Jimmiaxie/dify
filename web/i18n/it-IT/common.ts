const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account Xbrother',
    langGeniusAccountTip: 'Il tuo account Xbrother e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a Xbrother per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da Xbrother ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di Xbrother.',
  ...
  about: {
    ...
    nowAvailable: 'Xbrother {{version}} è ora disponibile.',
    latestAvailable: 'Xbrother {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
