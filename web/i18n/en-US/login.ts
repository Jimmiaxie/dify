const translation = {
  ...
  welcome: '👋 Welcome to Xbrother, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Xbrother Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Xbrother',
  invalid: 'The link has expired',
  explore: 'Explore Xbrother',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Xbrother and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Xbrother Enterprise license for your workspace has expired. Please contact your administrator to continue using Xbrother.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Xbrother license server. Please contact your administrator to continue using Xbrother.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Xbrother Enterprise license for your workspace is inactive. Please contact your administrator to continue using Xbrother.',
}
