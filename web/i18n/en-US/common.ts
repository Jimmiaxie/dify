const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Xbrother account',
    langGeniusAccountTip: 'Your Xbrother account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Xbrother to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Xbrother allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Xbrother\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Xbrother {{version}} is now available.',
    latestAvailable: 'Xbrother {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
