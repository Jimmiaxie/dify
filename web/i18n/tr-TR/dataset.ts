const translation = {
  ...
  intro1: 'Bilgi, Xbrother uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Xbrother dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
