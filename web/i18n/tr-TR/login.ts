const translation = {
  ...
  welcome: 'Xbrother\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Xbrother Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Xbrother\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Xbrother Enterprise lisansının süresi doldu. Xbrother\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Xbrother lisans sunucusuna bağlanılamadı. Xbrother\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Xbrother Enterprise lisansı etkin değil. Xbrother\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
