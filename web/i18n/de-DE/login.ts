const translation = {
  ...
  welcome: 'Willkommen bei Xbrother, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Xbrother Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Xbrother beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Xbrother erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Xbrother angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Xbrother-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Xbrother weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Xbrother Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Xbrother weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Xbrother Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Xbrother weiterhin zu verwenden.',
