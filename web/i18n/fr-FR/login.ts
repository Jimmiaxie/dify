const translation = {
  ...
  welcome: 'Bienvenue sur Xbrother, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Xbrother Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Xbrother',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Xbrother',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Xbrother et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Xbrother Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Xbrother.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Xbrother. Veuillez contacter votre administrateur pour continuer à utiliser Xbrother.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Xbrother Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Xbrother.',
