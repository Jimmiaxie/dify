const translation = {
  ...
  intro1: 'La Connaissance peut être intégrée dans l\'application Xbrother',
  ...
  externalAPIPanelDescription: 'L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de Xbrother et récupérer des connaissances de cette base de connaissances.',
