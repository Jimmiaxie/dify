const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Xbrother ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Xbrother و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
