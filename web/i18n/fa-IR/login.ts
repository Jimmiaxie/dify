const translation = {
  ...
  welcome: 'به Xbrother خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع Xbrother Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در Xbrother',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش Xbrother',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در Xbrother استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز Xbrother Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از Xbrother با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز Xbrother Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از Xbrother با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز Xbrother انجام نشد. لطفا برای ادامه استفاده از Xbrother با سرپرست خود تماس بگیرید.',
}
