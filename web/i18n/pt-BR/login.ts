const translation = {
  ...
  welcome: 'Bem-vindo ao Xbrother, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Xbrother, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Xbrother',
  invalid: 'O link expirou',
  explore: 'Explorar o Xbrother',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Xbrother e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Xbrother Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Xbrother.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Xbrother. Entre em contato com o administrador para continuar usando o Xbrother.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Xbrother Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Xbrother.',
}
