const translation = {
  ...
  welcome: 'Dobrodošli v Xbrother, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Xbrother Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Xbrother',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Xbrother',
  ...
  licenseExpiredTip: 'Licenca za Xbrother Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Xbrother, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Xbrother, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Xbrother ni uspela. Če želite še naprej uporabljati Xbrother, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Xbrother Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Xbrother, se obrnite na skrbnika.',
}
