const translation = {
  ...
  welcome: 'Witaj w Xbrother, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Xbrother, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Xbrother',
  invalid: 'Link wygasł',
  explore: 'Odkryj Xbrother',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Xbrother, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Xbrother Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Xbrother.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Xbrother. Skontaktuj się z administratorem, aby kontynuować korzystanie z Xbrother.',
  licenseInactiveTip: 'Licencja Xbrother Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Xbrother.',
}
