const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Xbrother ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Xbrother i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
