const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Xbrother',
    langGeniusAccountTip: 'Twoje konto Xbrother i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Xbrother, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Xbrother pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Xbrother.',
  ...
  about: {
    ...
    nowAvailable: 'Xbrother {{version}} jest teraz dostępny.',
    latestAvailable: 'Xbrother {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
